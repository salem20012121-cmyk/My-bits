...
async def start(event):
    # التحقق من الاشتراك الإجباري في القناة الجديدة
    ...
    await event.respond("🛡️ **أهلاً بك يا قائد في نظام الشد V12**\nالقناة الحالية: @gbdbbd", buttons=MAIN_KB)
...
async def main():
    ...
    print("✅ البوت يعمل بالقناة الجديدة @gbdbbd")
